    ...
    <section id={id} className="flex flex-col items-center justify-center gap-[20px] bg-[#F6F5F3] py-[40px]">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-[20px] lg:gap-[80px] xl:gap-[140px] mb-[40px]">
        <div className="hidden md:block md:relative aspect-[10/2] md:aspect-[4/3] w-[calc(100%-100px)] md:w-full md:scale-75 lg:scale-100">
          ...
          <img className="relative z-[2] w-full h-full object-cover rounded-[10px]" src={AboutUsImage} alt="Hombre soldando" />
        ...
        <div className="block md:hidden aspect-[10/7]">
          <img src={AboutUsImage} alt="Hombre soldando" className="w-[calc(100%-40px)] h-full object-cover rounded-[10px] mx-auto" />
        </div>
